...
export function FilterPanel({
  ...
  const filteredNets = netNames.filter((n) => n.toLowerCase().includes(searchTerm.toLowerCase()))
          ...
          <h3 className="flex items-center gap-2 font-semibold">
            ...
            <Tooltip>
              ...
              <TooltipContent side="right" className="max-w-xs">
                <p>
                  Use filters to focus on specific parts of your circuit. Select nets to see their
                  connections, or use neighborhood view to explore around a component.
                </p>
              </TooltipContent>
            </Tooltip>
          </h3>
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-1">
            ...
            <Tooltip>
              ...
              <TooltipContent side="right" className="max-w-xs">
                <p>
                  <strong>Show All</strong>: Display entire schematic
                </p>
                <p>
                  <strong>Filter by Net</strong>: Show only selected nets and connected components
                </p>
                <p>
                  <strong>Filter by Component</strong>: Show only selected components
                </p>
                <p>
                  <strong>Neighborhood</strong>: Show components within N hops of a center component
                </p>
              </TooltipContent>
            </Tooltip>
          </Label>
            ...
            <div className="space-y-2">
              <Label className="flex items-center gap-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="right" className="max-w-xs">
                    <p>
                      How many connection hops from the center component to show. 1 hop = directly
                      connected, 2 hops = connected to connected, etc.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </Label>
              <Select value={filter.neighborhoodDepth.toString()} onValueChange={handleDepthChange}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
