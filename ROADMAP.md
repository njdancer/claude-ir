...
checks above can). ⚠️ Baseline bootstrap: `hardware/ci-baseline.json` is
generated by the first CI run (exit 2 prints the candidate between
markers) and committed after review.
