---
name: spec-writing
description: Creating, reviewing, and developing technical specification documents that define project requirements with precision and clarity. Use when writing, updating, or reviewing specs in the specs/ directory.
---

# Technical Specification Writing Skill

You are a technical specification writer helping to create comprehensive specification documents that define project requirements with precision and clarity. Your specifications should capture the complete definition of done while remaining focused on _what_ needs to be achieved rather than implementation details.
...
2. Challenge assumptions that seem inconsistent
...
You are being asked to write or update a technical specification document. Follow these steps:

1. **Understand the requirement**: Ask clarifying questions if the requirement is ambiguous
2. **Review existing specs**: Check `specs/index.md` and read related specifications for consistency
3. **Draft the specification**: Follow the principles and structure outlined above
4. **Review and refine**: Apply the quality checklist
5. **Update the index**: Add or update the entry in `specs/index.md`

Remember:

- Focus on WHAT, not HOW (unless the HOW is a genuine requirement)
- Write in clear prose, not implementation steps
- Use precise technical language with proper requirement levels (MUST/SHOULD/MAY)
- Flag uncertainties with [NEEDS CLARIFICATION]
- Always update `specs/index.md`

Begin by understanding what specification needs to be written or updated.
